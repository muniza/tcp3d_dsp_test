...
override PKGDIR = xconfig_dsp_client
...
package/%.xdc.inc package/%_xconfig_dsp_client.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_dsp_client" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: dsp_client.cfg.pe66

-include package/cfg/dsp_client.cfg_pe66.mak
-include package/cfg/dsp_client.cfg_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dsp_client.cfg_pe66.dep
endif
dsp_client.cfg.pe66: package/cfg/dsp_client.cfg_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
dsp_client.cfg.pe66 package/cfg/dsp_client.cfg_pe66.c: .libraries,e66
endif

package/cfg/dsp_client.cfg_pe66.c package/cfg/dsp_client.cfg_pe66.h package/cfg/dsp_client.cfg_pe66.xdl: override _PROG_NAME := dsp_client.cfg.xe66
package/cfg/dsp_client.cfg_pe66.c: package/cfg/dsp_client.cfg_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/dsp_client.cfg_pe66.cfg
	-$(RM) package/cfg/dsp_client.cfg_pe66.dep
	-$(RM) package/cfg/dsp_client.cfg_pe66.c
	-$(RM) package/cfg/dsp_client.cfg_pe66.xdc.inc

clean,e66::
	-$(RM) dsp_client.cfg.pe66
.executables,e66 .executables: dsp_client.cfg.xe66

dsp_client.cfg.xe66: |dsp_client.cfg.pe66

-include package/cfg/dsp_client.cfg.xe66.mak
dsp_client.cfg.xe66: package/cfg/dsp_client.cfg_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/dsp_client.cfg_pe66.oe66   package/cfg/dsp_client.cfg_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
dsp_client.cfg.xe66: export C_DIR=
dsp_client.cfg.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

dsp_client.cfg.test test,e66 test: dsp_client.cfg.xe66.test

dsp_client.cfg.xe66.test:: dsp_client.cfg.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dsp_client.cfg.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dsp_client.cfg.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,dsp_client.cfg.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) dsp_client.cfg.xe66
clean:: 
	-$(RM) package/cfg/dsp_client.cfg_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
dsp_client.cfg_pe66.oe66,copy : package/cfg/dsp_client.cfg_pe66.oe66
dsp_client.cfg_pe66.se66,copy : package/cfg/dsp_client.cfg_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_dsp_client
xconfig_dsp_client.tar: package/package.bld.xml
xconfig_dsp_client.tar: package/build.cfg
xconfig_dsp_client.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_dsp_client.tar.dep
endif
package/rel/xconfig_dsp_client/xconfig_dsp_client/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_dsp_client.tar: package/rel/xconfig_dsp_client.xdc.inc package/rel/xconfig_dsp_client/xconfig_dsp_client/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_dsp_client.xdc.inc,package/rel/xconfig_dsp_client.tar.dep)


release release,xconfig_dsp_client: all xconfig_dsp_client.tar
clean:: .clean
	-$(RM) xconfig_dsp_client.tar
	-$(RM) package/rel/xconfig_dsp_client.xdc.inc
	-$(RM) package/rel/xconfig_dsp_client.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_dsp_client.pjt
