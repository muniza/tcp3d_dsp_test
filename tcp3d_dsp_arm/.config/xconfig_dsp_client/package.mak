...
.dlls,e66 .dlls: dsp_client.pe66

-include package/cfg/dsp_client_pe66.mak
-include package/cfg/dsp_client_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dsp_client_pe66.dep
endif
dsp_client.pe66: package/cfg/dsp_client_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
dsp_client.pe66 package/cfg/dsp_client_pe66.c: .libraries,e66
endif

package/cfg/dsp_client_pe66.c package/cfg/dsp_client_pe66.h package/cfg/dsp_client_pe66.xdl: override _PROG_NAME := dsp_client.xe66
package/cfg/dsp_client_pe66.c: package/cfg/dsp_client_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/dsp_client_pe66.cfg
	-$(RM) package/cfg/dsp_client_pe66.dep
	-$(RM) package/cfg/dsp_client_pe66.c
	-$(RM) package/cfg/dsp_client_pe66.xdc.inc

clean,e66::
	-$(RM) dsp_client.pe66
.executables,e66 .executables: dsp_client.xe66

dsp_client.xe66: |dsp_client.pe66

-include package/cfg/dsp_client.xe66.mak
dsp_client.xe66: package/cfg/dsp_client_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/dsp_client_pe66.oe66   package/cfg/dsp_client_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
dsp_client.xe66: export C_DIR=
dsp_client.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

dsp_client.test test,e66 test: dsp_client.xe66.test

dsp_client.xe66.test:: dsp_client.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dsp_client.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dsp_client.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,dsp_client.xe66,0,*
...
clean,e66::
	-$(RM) dsp_client.xe66
clean:: 
	-$(RM) package/cfg/dsp_client_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
dsp_client_pe66.oe66,copy : package/cfg/dsp_client_pe66.oe66
dsp_client_pe66.se66,copy : package/cfg/dsp_client_pe66.se66
